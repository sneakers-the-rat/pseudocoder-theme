...
" Copyright (c) 2019 Jonny Saunders.
...
hi Normal      guibg=#121419  guifg=#dee3ec    gui=none ctermbg=0 ctermfg=15
...
hi String      guibg=bg    guifg=#F9CD0F    ctermbg=bg  ctermfg=14
hi Character   guibg=bg    guifg=#FF522C      ctermbg=bg  ctermfg=14
hi Number      guibg=bg    guifg=#39A4FF      ctermbg=1   ctermfg=15
hi Boolean     guibg=bg    guifg=#39A4FF  gui=none    ctermbg=1   ctermfg=15
hi Float       guibg=bg    guifg=#39A4FF      ctermbg=1   ctermfg=15

hi Identifier  guibg=bg    guifg=#dee3ec      ctermbg=bg  ctermfg=12
hi Function    guibg=bg    guifg=#FF522C      ctermbg=bg  ctermfg=12
hi Statement   guibg=bg    guifg=#FF522C      ctermbg=bg  ctermfg=14

hi Conditional guibg=bg    guifg=#FF522C      ctermbg=bg  ctermfg=12
hi Repeat      guibg=bg    guifg=#FF522C      ctermbg=4   ctermfg=14
hi Label       guibg=bg    guifg=#ffccff      ctermbg=bg   ctermfg=13
hi Operator    guibg=bg    guifg=#FF522C      ctermbg=6   ctermfg=15
hi Keyword     guibg=bg    guifg=#FF522C      ctermbg=bg  ctermfg=10
hi Exception   guibg=bg    guifg=#FF522C      ctermbg=bg  ctermfg=10
...
hi StorageClass   guibg=bg   guifg=#FF522C      ctermbg=bg  ctermfg=10
...
hi SpecialComment guibg=#334455  guifg=#6E7A94    ctermbg=1   ctermfg=15
...
let g:colors_name = "pseudocoder"
let colors_name   = "pseudocoder"
